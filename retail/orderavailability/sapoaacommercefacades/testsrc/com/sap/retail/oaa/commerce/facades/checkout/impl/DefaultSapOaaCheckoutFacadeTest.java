...
public class DefaultSapOaaCheckoutFacadeTest
{
	...
	@Test
	public void doSourcingForSessionCart()
	{

		final DefaultSapOaaCheckoutFacade classUnderTest = EasyMock.createMockBuilder(DefaultSapOaaCheckoutFacade.class)
				.addMockedMethod("getCart").createMock();
