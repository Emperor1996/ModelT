...
public class DefaultReservationResultHandlerTest
{
	...
	public void deleteReservationNoItemsTest()
	{
		...
		order.setSapCarReservation(Boolean.TRUE);
		...
		Assert.assertEquals(Boolean.FALSE, order.getSapCarReservation());
	}
	...
	public void deleteReservationWithItemsTest()
	{
		...
		orderEntry.setSapCarReservation(Boolean.TRUE);
		...
		{
			Assert.assertEquals(Boolean.FALSE, entry.getSapCarReservation());
		}
	}
	...
	public void deleteReservationItemTest()
	{
		...
		Assert.assertEquals(Boolean.FALSE, orderEntry.getSapCarReservation());
	}
