...
public class DefaultATPResourcePathBuilder implements ATPResourcePathBuilder
{
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.sap.retail.oaa.commerce.services.atp.ATPResourcePathBuilder#compileUriQueryParameters(java.lang.String,
			...
			final String productUnit, final RestServiceConfiguration restConfiguration)
	{
		...
		multiValueMap.set(QUERY_PARAM_UNIT, StringUtils.left(productUnit, 3));
	 ...
	 *
	 * @see
	 * com.sap.retail.oaa.commerce.services.atp.ATPResourcePathBuilder#buildBatchRessourceServicePath(de.hybris.platform.
	 ...
	 *
	 * @see
	 * com.sap.retail.oaa.commerce.services.atp.ATPResourcePathBuilder#buildBatchRessourceServicePath(java.util.List)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.sap.retail.oaa.commerce.services.atp.ATPResourcePathBuilder#buildRessourceServicePath(de.hybris.platform.core.
