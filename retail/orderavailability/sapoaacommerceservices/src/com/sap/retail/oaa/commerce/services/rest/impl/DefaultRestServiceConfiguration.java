...
{
	protected static final Logger LOG = Logger.getLogger(DefaultRestServiceConfiguration.class);
	...
	protected void initializeGlobalConfiguration() throws RestInitializationException
	{
	...
	@Override
	public void initializeConfiguration() throws RestInitializationException
	{
	...
	protected void validateMode()
	{
		...
		{
			if (consumerId == null || oaaProfile == null || consumerId.isEmpty() || oaaProfile.isEmpty())
			{
	...
	{
		if (user == null || targetUrl == null || password == null || user.isEmpty() || targetUrl.isEmpty() || password.isEmpty())
		{
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.sap.retail.oaa.commerce.services.rest.RestServiceConfiguration#setSalesChannel(java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.sap.retail.oaa.commerce.services.rest.RestServiceConfiguration#getSalesChannel()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.sap.retail.oaa.commerce.services.rest.RestServiceConfiguration#setMode(com.sap.retail.oaa.model.enums.
	 * Sapoaa_switch)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.sap.retail.oaa.commerce.services.rest.RestServiceConfiguration#getMode()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.sap.retail.oaa.commerce.services.rest.RestServiceConfiguration#setConsumerId(java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.sap.retail.oaa.commerce.services.rest.RestServiceConfiguration#getConsumerId()
	 */
	@Override
