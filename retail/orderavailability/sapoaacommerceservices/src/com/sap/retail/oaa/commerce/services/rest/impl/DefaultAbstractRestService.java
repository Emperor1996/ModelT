...
{
	protected static final Logger LOG = Logger.getLogger(DefaultAbstractRestService.class);
	 ...
	 */
	protected void checkHttpStatusCode(final HttpClientErrorException e) throws CARBackendDownException
	{
	...
	{
		this.sessionService.setAttribute("CARBackendDown", new Boolean(backendDown));
	}
