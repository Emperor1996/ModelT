/*****************************************************************************
 Class:        InstorecsbackofficeManager
...
/**
 * This is the extension manager of the instorecsbackoffice extension.
 */
public class InstorecsbackofficeManager extends GeneratedInstorecsbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(InstorecsbackofficeManager.class.getName());
	 ...
	 */
	public InstorecsbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of InstorecsbackofficeManager called.");
		}
	}
	 ...
	 */
	public static InstorecsbackofficeManager getInstance()
	{
		return (InstorecsbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(InstorecsbackofficeConstants.EXTENSIONNAME);
	}
