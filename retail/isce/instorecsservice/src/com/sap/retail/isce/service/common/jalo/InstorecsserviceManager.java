...
/**
 * This is the extension manager of the Instorecsservice extension.
 */
public class InstorecsserviceManager extends GeneratedInstorecsserviceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(InstorecsserviceManager.class.getName());
	 ...
	 */
	public InstorecsserviceManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of InstorecsserviceManager called.");
		}
	}
	 ...
	 */
	public static InstorecsserviceManager getInstance()
	{
		return (InstorecsserviceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(InstorecsserviceConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of InstorecsserviceManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of InstorecsserviceManager called, current tenant: " + getTenant().getTenantID());
		}
	}
