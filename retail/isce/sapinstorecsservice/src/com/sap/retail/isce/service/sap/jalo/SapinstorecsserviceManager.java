/*****************************************************************************
 Class:        SapinstorecsserviceManager.java
...
/**
 * This is the extension manager of the Sapinstorecsservice extension.
 */
public class SapinstorecsserviceManager extends GeneratedSapinstorecsserviceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapinstorecsserviceManager.class.getName());
	 ...
	 */
	public SapinstorecsserviceManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapinstorecsserviceManager called.");
		}
	}
	 ...
	 */
	public static SapinstorecsserviceManager getInstance()
	{
		return (SapinstorecsserviceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapinstorecsserviceConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapinstorecsserviceManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapinstorecsserviceManager called, current tenant: " + getTenant().getTenantID());
		}
	}
