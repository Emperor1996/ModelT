...
/**
 * This is the extension manager of the Instorecsfacade extension.
 */
public class InstorecsfacadeManager extends GeneratedInstorecsfacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(InstorecsfacadeManager.class.getName());
	 ...
	 */
	public InstorecsfacadeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of InstorecsfacadeManager called.");
		}
	}
	 ...
	 */
	public static InstorecsfacadeManager getInstance()
	{
		return (InstorecsfacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(InstorecsfacadeConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of InstorecsfacadeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of InstorecsfacadeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
