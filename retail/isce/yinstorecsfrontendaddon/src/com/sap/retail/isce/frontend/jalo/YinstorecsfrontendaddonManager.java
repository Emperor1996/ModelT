/*****************************************************************************
 Class:        YinstorecsfrontendaddonManager
...
/**
 * This is the extension manager of the Yinstorecsfrontendaddon extension.
 */
public class YinstorecsfrontendaddonManager extends GeneratedYinstorecsfrontendaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YinstorecsfrontendaddonManager.class.getName());
	 ...
	 */
	public YinstorecsfrontendaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YinstorecsfrontendaddonManager called.");
		}
	}
	 ...
	 */
	public static YinstorecsfrontendaddonManager getInstance()
	{
		return (YinstorecsfrontendaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(YinstorecsfrontendaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of YinstorecsfrontendaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of YinstorecsfrontendaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
