/*****************************************************************************
Class: DefaultPPSConfigurationServiceTest
...
public class DefaultPPSConfigurationServiceTest
{
	...
	public void setUp()
	{
		...
		sapConfig.setSappps_cacheCatalogPrices(Boolean.TRUE);
	...
	@Test
	public void testGetCacheEnabledTrue()
	{
		assertTrue(cut.isCacheCatalogPrices(product));
	}

	@Test
	public void testGetCacheEnabledNull()
	{
		sapConfig.setSappps_cacheCatalogPrices(null);
		assertFalse(cut.isCacheCatalogPrices(product));
	}

	@Test
	public void testGetCacheEnabledPPSInactive()
	{
	...
	@Test
	public void testGetCacheEnabledPPSNull()
	{
		sapConfig.setSappps_active(null);
		assertFalse(cut.isCacheCatalogPrices(product));
	}

	@Test
	public void testGetCacheEnabledFalse()
	{
		sapConfig.setSappps_cacheCatalogPrices(Boolean.FALSE);
		assertFalse(cut.isCacheCatalogPrices(product));
	}

	@Test
	public void testGetCacheEnabledNoConfig()
	{
